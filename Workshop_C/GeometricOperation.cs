...
public class GeometricOperation
{
    ...
    public double CalculateCircleArea(double radius)
    {
        ...
        double c = Math.PI * r;
        double r2 = Math.Round(c, 2, MidpointRounding.AwayFromZero);
    ...
    public double CalculateConeVolume(double radius, double height)
    {
        ...
        double rd = Math.Round(v, 1, MidpointRounding.AwayFromZero);
        return rd;
    }
    ...
    public double CalculateRegularPolygonArea(int numSides, double sideLength)
    {
        ...
        double a = sideLength / (2 * Math.Tan(Math.PI / numSides));
        double p = numSides * sideLength;
        double a2 = 0.5 * a * p; 
        double r = Math.Round(a2, 1, MidpointRounding.AwayFromZero);
